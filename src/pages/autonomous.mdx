...
In *Caf.js*, cloud-based multi-tasking is implemented by some trickery in the [Launcher](https://github.com/cafjs/caf_launcher.git) app, and enabling **proactive server side rendering** in most of our apps. We will describe this technique in a moment.
