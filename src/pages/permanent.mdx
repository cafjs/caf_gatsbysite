...
If a virtual world represents your real home, and action in VR could switch off the lights of your real home, thousands of miles away.

This could be implemented by creating an avatar of the lamp, which forwards actions to the physical lamp across the Internet. However, this is not an easy problem to solve. Any delays or connectivity issues will ruin the virtual experience. And directly exposing your lamp to the Internet is risky.
...
What about AR? The use case is very different, but the underlying technology is the same. You are likely to be in the same room, and when you look fixedly at the physical lamp, a user interface will pop up allowing you to change the color hue.
