...
**Caf.js** makes devices and web app instances always accessible from anywhere at any time. An abstraction that we call **reverse service worker** keeps them safe. A **three-way isomorphic** framework enables quick prototyping of new sharing experiences.
