...
We don't care what you do in your app, as long as it is legal. You can run your own in-app purchase infrastructure. Or link to your website to manage subscriptions. Or make money from ads.
...
When you deploy your app using  <Link to="/docs/documentation#cafjs-cloud">Turtles</Link>, it starts in **Incubator** mode. In that mode resources are minimal, but they will grow when other users subscribe to your app.

**Incubator** mode enables a very low maintenance cost for your new app. Currently less than **$6 per year** (one unit a week).
