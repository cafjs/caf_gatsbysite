        ...
        <div className="docs-overview py-5">
          <Row className="justify-content-center">
            <Col md="12" lg="6" className="py-3">
              <MyCard title="Permanent" description="Give a permanent presence to your devices and apps with <span class=&quot;font-weight-bold&quot;>Reverse Service Workers</span>. Interact with them safely at any time from anywhere. Share them by simply exchanging a URL." nextPage="/permanent"><Lighthouse width="35" height="35"/></MyCard>
            </Col>
            <Col md="12" lg="6" className="py-3">
